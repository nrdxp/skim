...
fn real_main() -> Result<i32, std::io::Error> {
    ...
    let opts = App::new("sk")
        ...
        .arg(Arg::with_name("multi").long("multi").short('m').multiple(true).takes_value(true))
        .arg(Arg::with_name("no-multi").long("no-multi").multiple(true).takes_value(true))
        ...
        .arg(Arg::with_name("tac").long("tac").multiple(true).takes_value(true))
        .arg(Arg::with_name("tiebreak").long("tiebreak").short('t').multiple(true).takes_value(true))
        .arg(Arg::with_name("ansi").long("ansi").multiple(true).takes_value(true))
        .arg(Arg::with_name("exact").long("exact").short('e').multiple(true).takes_value(true))
        .arg(Arg::with_name("cmd").long("cmd").short('c').multiple(true).takes_value(true))
        .arg(Arg::with_name("interactive").long("interactive").short('i').multiple(true).takes_value(true))
        ...
        .arg(Arg::with_name("regex").long("regex").multiple(true).takes_value(true))
        ...
        .arg(Arg::with_name("no-height").long("no-height").multiple(true).takes_value(true))
        .arg(Arg::with_name("no-clear").long("no-clear").multiple(true).takes_value(true))
        .arg(Arg::with_name("no-clear-start").long("no-clear-start").multiple(true).takes_value(true))
        .arg(Arg::with_name("no-mouse").long("no-mouse").multiple(true).takes_value(true))
        ...
        .arg(Arg::with_name("no-hscroll").long("no-hscroll").multiple(true).takes_value(true))
        .arg(Arg::with_name("hscroll-off").long("hscroll-off").multiple(true).takes_value(true).default_value("10"))
        .arg(Arg::with_name("filepath-word").long("filepath-word").multiple(true).takes_value(true))
        .arg(Arg::with_name("jump-labels").long("jump-labels").multiple(true).takes_value(true).default_value("abcdefghijklmnopqrstuvwxyz"))
        .arg(Arg::with_name("border").long("border").multiple(true).takes_value(true))
        .arg(Arg::with_name("inline-info").long("inline-info").multiple(true).takes_value(true))
        ...
        .arg(Arg::with_name("no-bold").long("no-bold").multiple(true).takes_value(true))
        ...
        .arg(Arg::with_name("print-query").long("print-query").multiple(true).takes_value(true))
        .arg(Arg::with_name("print-cmd").long("print-cmd").multiple(true).takes_value(true))
        .arg(Arg::with_name("print-score").long("print-score").multiple(true).takes_value(true))
        .arg(Arg::with_name("read0").long("read0").multiple(true).takes_value(true))
        .arg(Arg::with_name("print0").long("print0").multiple(true).takes_value(true))
        .arg(Arg::with_name("sync").long("sync").multiple(true).takes_value(true))
        .arg(Arg::with_name("extended").long("extended").short('x').multiple(true).takes_value(true))
        .arg(Arg::with_name("no-sort").long("no-sort").multiple(true).takes_value(true))
        .arg(Arg::with_name("select-1").long("select-1").short('1').multiple(true).takes_value(true))
        .arg(Arg::with_name("exit-0").long("exit-0").short('0').multiple(true).takes_value(true))
        ...
        .arg(Arg::with_name("keep-right").long("keep-right").multiple(true).takes_value(true))
        ...
        .arg(Arg::with_name("no-clear-if-empty").long("no-clear-if-empty").multiple(true).takes_value(true))
        .arg(Arg::with_name("show-cmd-error").long("show-cmd-error").multiple(true).takes_value(true))
